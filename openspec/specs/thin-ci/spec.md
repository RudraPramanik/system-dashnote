...
Thin PR CI (Slice 8X.1 / 7P.7): inventory-driven GitHub Actions that run pytest then Docker build without production secrets, with Dockerfile Python/apt parity and an unbroken local Compose path.
